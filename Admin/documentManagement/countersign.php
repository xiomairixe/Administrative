  ...
  <div class="row g-0">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <div class="card">
          <div class="card-body">
            <h6 class="fw-bold mb-2">Your Signature</h6>
            <p class="text-muted mb-3">By signing this document, you confirm that you have read and agree to its contents.</p>
            <button class="btn btn-primary">Sign Document</button>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4">
        <div class="card mb-3">
          <div class="card-body">
            ...
            <div class="mb-2">
              <small class="fw-semibold">Status</small><br>
              <span class="badge bg-warning text-dark">Pending Countersignature</span>
            </div>
            <div class="mb-2">
              <small class="fw-semibold">Uploaded by</small><br>
              John Doe
            </div>
            <div>
              <small class="fw-semibold">Due Date</small><br>
              2023-12-18
            </div>
          </div>
        </div>
        ...
        <div class="alert alert-warning">
          ...
          All parties must sign this document before it can be finalized. Your signature is legally binding.
        </div>

        <div class="card">
          <div class="card-body">
            <h6 class="fw-bold mb-3">Signatories</h6>

            <div class="d-flex align-items-center mb-2">
              <div class="avatar me-2">J</div>
              <div>
                <strong>John Doe</strong><br>
                <small>Procurement Manager</small><br>
                <span class="badge bg-success">Signed</span>
              </div>
            </div>

            <div class="d-flex align-items-center mb-2">
              <div class="avatar me-2">S</div>
              <div>
                <strong>Sarah Johnson</strong><br>
                <small>Legal Counsel</small><br>
                <span class="badge bg-success">Signed</span>
              </div>
            </div>
            ...
            <div class="d-flex align-items-center mb-2">
              ...
              <div>
                ...
                <small>Finance Director</small><br>
                <span class="badge bg-warning text-dark">Pending</span>
              </div>
            </div>

            <div class="d-flex align-items-center">
              <div class="avatar me-2">R</div>
              <div>
                <strong>Robert Chen</strong><br>
                <small>XYZ Corp Representative</small><br>
                <span class="badge bg-warning text-dark">Pending</span>
              </div>
            </div>
          </div>
