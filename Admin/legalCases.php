  ...
  <div class="row g-0">
        ...
        <div class="">
          ...
          <div class="mb-4">
            ...
            <nav class="nav flex-column">
              ...
              <a class="nav-link active" href="#"><ion-icon name="document-text-outline"></ion-icon>Legal Request</a>
    ...
    <div class="col main-content">
      <div class="main-content bg-white rounded shadow-sm p-4">
        <h3 class="dashboard-title mb-4">Legal Requests</h3>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <a href="addrequest.php" class="btn btn-primary text-white">New Request</a>
        </div>
        ...
        <table class="table table-bordered align-middle">
          ...
          <tbody>
            <tr>
              ...
              <td>7/23/2023</td>
              <td>
                <button class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#requestModal">👁️</button>
              </td>
            </tr>
          </tbody>
        </table>
