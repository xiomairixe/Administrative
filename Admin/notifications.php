  ...
  <div class="row g-0">
        ...
        <div class="">
          ...
          <div class="mb-4">
            ...
            <nav class="nav flex-column">
              ...
              <a class="nav-link active" href="#"><ion-icon name="notifications-outline"></ion-icon>Notifications</a>
            </nav>
          </div>
    ...
    <div class="col main-content">
      ...
      <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
          <h3 class="mb-2 mb-md-0">Notifications</h3>
          <div class="d-flex flex-wrap gap-2">
            <button class="btn btn-outline-secondary">Mark All Read</button>
            <button class="btn btn-outline-primary">Settings</button>
          </div>
        </div>

        <ul class="nav nav-tabs tab-btns mb-3" id="notificationTabs" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="all-tab" data-bs-toggle="tab" data-bs-target="#all" type="button" role="tab">All <span class="badge bg-light text-dark">6</span></button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="unread-tab" data-bs-toggle="tab" data-bs-target="#unread" type="button" role="tab">Unread <span class="badge bg-light text-dark">3</span></button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="deadlines-tab" data-bs-toggle="tab" data-bs-target="#deadlines" type="button" role="tab">Deadlines</button>
          </li>
          <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="notificationTabContent">
          <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
            <div class="notification-item">
              <div class="notification-content">
                <strong class="text-danger">Contract Review Deadline</strong><br>
                <span>The vendor agreement needs to be reviewed by tomorrow</span>
              </div>
          ...
          <div class="tab-pane fade" id="unread" role="tabpanel"> <p>No new unread notifications.</p></div>
          <div class="tab-pane fade" id="deadlines" role="tabpanel"> <p>No deadlines at the moment.</p></div>
          <div class="tab-pane fade" id="tasks" role="tabpanel"> <p>No assigned tasks.</p></div>
          <div class="tab-pane fade" id="updates" role="tabpanel"> <p>No new updates.</p></div>
        </div>
        ...
        <div class="settings-box">
          ...
          <div class="form-check">
            ...
            <label class="form-check-label" for="reminders">Deadline Reminders</label>
          </div>
          <div class="form-check">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" id="regulatoryAlerts">
            <label class="form-check-label" for="regulatoryAlerts">Regulatory Alerts</label>
          </div>
        </div>
    </div>
    </div>
