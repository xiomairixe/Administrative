        ...
        <div class="">
          ...
          <div class="mb-4">
            ...
            <nav class="nav flex-column">
              ...
              <a class="nav-link active" href="#"><ion-icon name="bar-chart-outline"></ion-icon>Reports</a>
    ...
    <main class="col-md-10 main-content"> 
      <div class="topbar mb-4">
        ...
        <div class="container py-4 px-0">
          <h3 class="mb-4">Report Generator</h3>

          <!-- Report Generator -->
          <div class="card p-4 mb-4">
            <h5>Generate a new report</h5>
            <form class="row g-3 align-items-end">
              ...
              <div class="col-md-12">
                <button class="btn btn-primary btn-generate">Generate Report</button>
              </div>
            </form>
          </div>
          ...
          <div class="card p-4 mb-4">
            ...
            <div class="list-group">
              <div class="list-group-item d-flex justify-content-between align-items-start template-box">
                <div class="ms-2 me-auto">
                  <div class="fw-bold">
                    <i class="bi bi-file-earmark-text report-icon"></i>
                    Monthly Compliance Summary
                  </div>
                  <small
                    >Overview of all compliance activities and statuses for the month<br />
                    Format: PDF • Last generated: July 10, 2023</small
                  >
                </div>
                <div class="btn-group">
              ...
              <div class="list-group-item d-flex justify-content-between align-items-start template-box">
                <div class="ms-2 me-auto">
                  ...
                  <small
                    >Compliance ratings by department with risk indicators<br />
                    Format: PDF/Dashboard • Last generated: July 1, 2023</small
                  >
                </div>
                <div class="btn-group">
                  <button class="btn btn-outline-secondary btn-sm">Edit</button>
          ...
          <div class="card p-4">
            ...
            <ul class="list-group">
              <li class="list-group-item d-flex justify-content-between align-items-center">
                <div>
                  <strong>July 2023 Compliance Summary</strong><br />
                  <small>Monthly Report • Generated on Jul 10, 2023</small>
                </div>
                <div class="d-flex align-items-center gap-2">
                  <span class="status-complete">Complete</span>
                  <button class="btn btn-primary btn-sm btn-download">Download</button>
                </div>
              </li>
              <li class="list-group-item d-flex justify-content-between align-items-center">
                <div>
                  <strong>Q2 2023 Regulatory Update Digest</strong><br />
                  <small>Quarterly Report • Generated on Jul 3, 2023</small>
                </div>
                <div class="d-flex align-items-center gap-2">
                  <span class="status-complete">Complete</span>
                  <button class="btn btn-primary btn-sm btn-download">Download</button>
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center">
                <div>
                  <strong>Contract Review Metrics - June 2023</strong><br />
                  <small>Monthly Report • Generated on Jul 2, 2023</small>
                </div>
                <div class="d-flex align-items-center gap-2">
                  <span class="status-complete">Complete</span>
                  <button class="btn btn-primary btn-sm btn-download">Download</button>
