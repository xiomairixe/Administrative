...
<body>
  ...
  <div class="main-content">
    ...
    <!-- ✅ Head Visitor Modal (move this INSIDE the loop) -->
    <div class="modal fade" id="headVisitorModal<?php echo $facility_id ?>" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog">
        <form action="register_head_visitor.php" method="post">
        ...
        <div class="modal fade" id="manageModal" tabindex="-1" aria-labelledby="manageModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content border-0 shadow-lg">
              ...
              <form id="facilityForm" method="POST" action="process_reservation.php">
                <div class="modal-body">
